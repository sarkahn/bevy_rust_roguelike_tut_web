...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd63682181054997c: (a: number, b: number, c: number) => void;
